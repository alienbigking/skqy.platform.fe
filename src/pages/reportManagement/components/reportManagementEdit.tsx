...
import styles from './reportManagementEdit.less'
...
const ReportManagementEdit: React.FC<Props> = memo((props) => {
  ...
  return (
    <Modal
      className={cn(styles.reportAnalysisEdit)}
      title="提交结论"
      open={isVisible}
      width={568}
      onOk={onOk}
...
export default ReportManagementEdit
