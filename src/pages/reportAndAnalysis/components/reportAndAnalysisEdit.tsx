...
import styles from './reportAndAnalysisEdit.less'
...
const ReportAndAnalysisEdit: React.FC<Props> = memo((props) => {
  ...
  return (
    <Modal
      className={cn(styles.reportAndAnalysisEdit)}
      title="提交结论"
      open={isVisible}
      width={568}
      onOk={onOk}
...
export default ReportAndAnalysisEdit
