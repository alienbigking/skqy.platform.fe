...
import styles from './organizationBusinessNew.less'
...
const OrganizationBusinessNew: React.FC<Props> = memo((props) => {
  ...
  return (
    <Modal
      className={cn(styles.organizationBusinessNew)}
      title="新增机构业务配置"
      open={isVisible}
      width={568}
      centered
...
export default OrganizationBusinessNew
