...
import styles from './aiAutoReportAudit.less'
...
const AiAutoReportAudit: React.FC<Props> = memo((props) => {
  ...
  useEffect(() => {
    if (synthesisConclusion && innerHTMLRemark) {
      console.log('表单信息填写完成，开始生成 PDF...')
      appendPageToPdf()
    }
  }, [synthesisConclusion, innerHTMLRemark])
  ...
  return (
    <Drawer
      className={cn(styles.aiAutoReportAudit)}
      title="AI自动报告审核"
      open={isVisible}
      width={'100%'}
      onClose={onCancel}
              ...
              <div className={cn(styles.main)}>
                <div className={cn(styles.content)}>
                  ...
                  <div className={cn(styles.physician)}>
                    ...
                    <div className={cn([styles.physicianFooter])}></div>
                  </div>
...
export default AiAutoReportAudit
